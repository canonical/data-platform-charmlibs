...
# In CI, $CHARMLIBS_TAG is set based on pyproject.toml:tool.dpcharmlibs.integration.tags
...
charmcraft pack
cd -
mv "$TMP_DIR"/*.charm "$PACKED_DIR/${CHARMLIBS_SUBSTRATE}_ubuntu-24.04-amd64.charm"
